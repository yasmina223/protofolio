...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Skills</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    skill</span>
            </div>
        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-outline-success btn-sm"
                                                        data-id="{{ $skill->id }}" data-skill="{{ $skill->skills }}"
                        ...
                        <div class="modal-content modal-content-demo">
                            ...
                            <form action="skills/destroy" method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input class="form-control" name="skill" id="skill" type="text" readonly>
                                </div>
                                <div class="modal-footer">
